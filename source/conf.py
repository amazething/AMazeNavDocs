...
latex_documents = [
    (master_doc, 'AMazeNavDocs.tex', 'AMazeNavDocs Documentation',
     'AMaze', 'manual'),
]
...
man_pages = [
    (master_doc, 'amazenavdocs', 'AMazeNavDocs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AMazeNavDocs', 'AMazeNavDocs Documentation',
     author, 'AMazeNavDocs', 'One line description of project.',
     'Miscellaneous'),
]
